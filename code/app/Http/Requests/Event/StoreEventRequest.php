...
class StoreEventRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'type' => ['required', Rule::in(['seminar', 'workshop', 'conference', 'summer_school', 'meeting', 'other'])],
    ...
    public function withValidator($validator): void
    {
        $validator->after(function ($validator) {
            // Ensure at least one location language is provided
            if (empty($this->location_ar) && empty($this->location_fr) && empty($this->location_en)) {
                $validator->errors()->add('location_ar', 'يجب توفير الموقع بلغة واحدة على الأقل.');
            }
