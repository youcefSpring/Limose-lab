<x-app-layout>
    ...
    <header class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6 lg:mb-8">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h1 class="text-xl sm:text-2xl font-semibold">{{ __('Create New Project') }}</h1>
                <p class="text-zinc-500 dark:text-zinc-400 text-sm mt-1">{{ __('Define a new research project') }}</p>
            </div>
        </div>
    </header>
            ...
            <div class="glass-card rounded-2xl p-5 lg:p-6">
                ...
                <div class="mb-5">
                    ...
                    <p class="mt-2 text-xs text-zinc-500 dark:text-zinc-400">
                        {{ __('Optional: Define the specific goals and objectives you aim to achieve') }}
                    </p>
                </div>
