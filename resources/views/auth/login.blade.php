<x-guest-layout>
    ...
    <!-- Page Title -->
    <div class="mb-6">
        <h2 class="text-2xl font-semibold">{{ __('messages.Welcome Back') }}</h2>
        <p class="text-sm text-zinc-500 dark:text-zinc-400 mt-1">{{ __('messages.Sign in to your account to continue') }}</p>
    </div>
