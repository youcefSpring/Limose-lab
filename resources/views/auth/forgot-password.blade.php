<x-guest-layout>
    <!-- Page Title -->
    <div class="mb-6">
        <h2 class="text-2xl font-semibold">{{ __('messages.Forgot Password?') }}</h2>
        <p class="text-sm text-zinc-500 dark:text-zinc-400 mt-1">
            {{ __('messages.No problem. Just let us know your email address and we will email you a password reset link.') }}
        </p>
    </div>
