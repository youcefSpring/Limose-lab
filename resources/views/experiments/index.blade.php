                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center justify-center gap-2">
                                        ...
                                        @can('delete', $experiment)
                                            <form method="POST" action="{{ route('experiments.destroy', $experiment) }}" class="inline-block" onsubmit="return confirm('{{ __('messages.Are you sure you want to delete this experiment?') }}')">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit"
