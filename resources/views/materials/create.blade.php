        ...
        <form method="POST" action="{{ route('materials.store') }}" enctype="multipart/form-data">
            ...
            <div class="glass-card rounded-2xl p-6">
                <div class="mb-6">
                    ...
                    <p class="text-sm text-zinc-500 dark:text-zinc-400">{{ __('Fill in the details for the new material') }}</p>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                    ...
                    <div class="md:col-span-2 lg:col-span-3">
                        ...
                        <textarea name="description" id="description" rows="3"
                            ...
                            placeholder="{{ __('Brief description...') }}">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="mt-1.5 text-xs text-accent-rose">{{ $message }}</p>
                        @enderror
                    </div>
