                                ...
                                <td class="px-4 py-3">
                                    <div class="flex items-center justify-center gap-2">
                                        ...
                                        @can('delete', $material)
                                            <button 
                                                x-data
                                                onclick="openDeleteModal({{ $material->id }}, '{{ route('materials.destroy', ':id') }}'.replace(':id', {{ $material->id }}))"
                                                class="p-1.5 rounded-lg hover:bg-accent-rose/10 text-accent-rose transition-colors" 
