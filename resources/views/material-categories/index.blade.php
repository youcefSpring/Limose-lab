                            ...
                            <tr class="hover:bg-zinc-50/50 dark:hover:bg-white/5 transition-colors">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center justify-center gap-2">
                                        ...
                                        @endcan
                                        @can('delete', $category)
                                            <form method="POST" action="{{ route('material-categories.destroy', $category) }}" class="inline-block" onsubmit="return confirm('{{ __('messages.Are you sure you want to delete this category? Categories with materials cannot be deleted.') }}')">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit"
