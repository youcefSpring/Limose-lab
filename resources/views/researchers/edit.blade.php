@extends('layouts.app', ['title' => __('Edit Researcher')])

@section('content')
<div id="researchers-edit-container">
    <!-- Page Header -->
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="h3 fw-bold text-dark">{{ __('Edit Researcher Profile') }}</h2>
            <p class="text-muted mb-0">{{ __('Update researcher information') }}</p>
        </div>
        <div class="d-flex gap-2">
            <a href="{{ route('researchers.show', $researcher) }}" class="btn btn-outline-info">
    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="card shadow-sm">
                <div class="card-body">
                    <form id="researcherForm" method="POST" action="{{ route('researchers.update', $researcher) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="email" class="form-control @error('email') is-invalid @enderror"
                                           id="email" name="email" value="{{ old('email', $researcher->user->email) }}" required>
                                    @error('email')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="tel" class="form-control @error('phone') is-invalid @enderror"
                                           id="phone" name="phone" value="{{ old('phone', $researcher->user->phone) }}">
                                    @error('phone')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <div class="form-text">{{ __('Upload a new profile photo to replace the current one (max 2MB, JPG/PNG only)') }}</div>
                                    @error('photo')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('position') is-invalid @enderror"
                                           id="position" name="position" value="{{ old('position', $researcher->user->position) }}"
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('department') is-invalid @enderror"
                                           id="department" name="department" value="{{ old('department', $researcher->user->department) }}">
                                    @error('department')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('research_domain') is-invalid @enderror"
                                           id="research_domain" name="research_domain" value="{{ old('research_domain', $researcher->research_domain) }}" required
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('orcid') is-invalid @enderror"
                                           id="orcid" name="orcid" value="{{ old('orcid', $researcher->user->orcid) }}"
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="url" class="form-control @error('google_scholar_url') is-invalid @enderror"
                                           id="google_scholar_url" name="google_scholar_url" value="{{ old('google_scholar_url', $researcher->google_scholar_url) }}"
                                ...
                                <div class="tab-content" id="bioTabContent">
                                    <div class="tab-pane fade show active" id="bio-en" role="tabpanel">
                                        <textarea class="form-control @error('bio_en') is-invalid @enderror"
                                                  name="bio_en" rows="4"
                                                  placeholder="{{ __('Enter biography in English...') }}">{{ old('bio_en', $researcher->bio_en) }}</textarea>
                                        @error('bio_en')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="tab-pane fade" id="bio-fr" role="tabpanel">
                                        <textarea class="form-control @error('bio_fr') is-invalid @enderror"
                                                  name="bio_fr" rows="4"
                                                  placeholder="{{ __('Enter biography in French...') }}">{{ old('bio_fr', $researcher->bio_fr) }}</textarea>
                                        @error('bio_fr')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="tab-pane fade" id="bio-ar" role="tabpanel">
                                        <textarea class="form-control @error('bio_ar') is-invalid @enderror"
                                                  ...
                                                  placeholder="{{ __('Enter biography in Arabic...') }}">{{ old('bio_ar', $researcher->bio_ar) }}</textarea>
                                        @error('bio_ar')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                        ...
                        <div class="mb-4">
                            ...
                            @if($researcher->cv_path)
                                <div class="mb-3">
                                    <div class="alert alert-info">
                                        ...
                                        {{ __('Current CV:') }}
                                        <a href="{{ asset('storage/' . $researcher->cv_path) }}" target="_blank" class="text-decoration-none">
                                            {{ __('View Current CV') }}
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <div class="form-text">{{ __('Upload a new CV file to replace the current one (PDF, DOC, or DOCX - max 5MB)') }}</div>
                                    @error('cv_file')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="url" class="form-control @error('linkedin_url') is-invalid @enderror"
                                           id="linkedin_url" name="linkedin_url" value="{{ old('linkedin_url', $researcher->user->linkedin_url) }}"
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="url" class="form-control @error('researchgate_url') is-invalid @enderror"
                                           id="researchgate_url" name="researchgate_url" value="{{ old('researchgate_url', $researcher->user->researchgate_url) }}"
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="url" class="form-control @error('website_url') is-invalid @enderror"
                                           id="website_url" name="website_url" value="{{ old('website_url', $researcher->user->website_url) }}"
                        ...
                        <div class="d-flex gap-2">
                            ...
                            @if(auth()->user()->isAdmin() || auth()->user()->isLabManager())
                                <button type="button" class="btn btn-outline-danger ms-auto" id="deleteBtn" data-bs-toggle="modal" data-bs-target="#deleteModal">
                                    <i class="fas fa-trash me-2"></i>{{ __('Delete Profile') }}
                                </button>
                            @endif
                        </div>
                    </form>
            ...
            <div class="card shadow-sm">
                <div class="card-header">
                    <h6 class="card-title mb-0">
                        <i class="fas fa-info-circle me-2"></i>{{ __('Profile Update Guidelines') }}
                    </h6>
                </div>
                <div class="card-body">
                    <div class="mb-3">
                        <h6 class="fw-bold">{{ __('Personal Information') }}</h6>
                        <p class="small text-muted">{{ __('Keep your personal details up to date for accurate communication.') }}</p>
                    </div>

                    <div class="mb-3">
                        <h6 class="fw-bold">{{ __('Research Domain') }}</h6>
                        <p class="small text-muted">{{ __('Update your research areas as your interests evolve.') }}</p>
                    </div>

                    <div class="mb-3">
                        <h6 class="fw-bold">{{ __('ORCID ID') }}</h6>
                        <p class="small text-muted">{{ __('Your unique researcher identifier for academic publications.') }}</p>
                    </div>

                    <div class="mb-3">
                        <h6 class="fw-bold">{{ __('Biography') }}</h6>
                        <p class="small text-muted">{{ __('Keep your biography current and available in multiple languages.') }}</p>
                    </div>

                    <div class="mb-3">
                        <h6 class="fw-bold">{{ __('File Updates') }}</h6>
                        <ul class="small text-muted">
                            <li>{{ __('New photo will replace current one') }}</li>
                            <li>{{ __('New CV will replace current one') }}</li>
                            <li>{{ __('Leave blank to keep current files') }}</li>
                        </ul>
                    </div>
                    ...
                    <div class="alert alert-warning">
                        ...
                        {{ __('Changes will be saved immediately when you click Update Profile.') }}
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="deleteModalLabel">{{ __('Delete Researcher Profile') }}</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <p>{{ __('Are you sure you want to delete this researcher profile?') }}</p>
                <p class="text-muted small">{{ __('This action cannot be undone. All associated data including projects, publications, and collaborations will be affected.') }}</p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">{{ __('Cancel') }}</button>
                <form method="POST" action="{{ route('researchers.destroy', $researcher) }}" class="d-inline">
                    @csrf
                    @method('DELETE')
                    <button type="submit" class="btn btn-danger">{{ __('Delete Profile') }}</button>
                </form>
            </div>
        </div>
    </div>
...
$(document).ready(function() {
    ...
    function showAlert(type, message) {
        ...
        $('#researchers-edit-container').prepend(alertHtml);
